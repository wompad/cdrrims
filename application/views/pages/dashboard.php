	...
	<div role="main">
      ...
      <div class="row tile_count">
        <div class="col-md-12 col-sm-12 col-xs-12 tile_stats_count">
          <center><h4><strong>Total for Disaster Events 2018</strong></h4></center>
        </div>
          ...
          <div class="dashboard_graph">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
              <div class="x_panel" style="border: 3px solid #E74C3C; height:653px; overflow:auto">
                <div class="x-title green"><h4><strong>Public Weather Forecast <span id="issuedat"></span></strong></h4>
                  <div class="clearfix"></div>
                </div>
                <div class="x-content">
