		...
		if(a == 0){
			...
			$.getJSON(serverip+"get_evac_stats",datas,function(a){
				...
				$("#evac_stats tbody").append(
					"<tr style='color:#fff;'>"+
						"<th style='border: 1px solid #000; text-align:left; padding:2px; background-color: #808080; color: #000' border='1'><b>CARAGA</b></th>"+
				...
				$("#tbl_casualty_asst tbody").append(
					"<tr style='background-color:#AC2925; color:#fff'>"+
						"<th style='border: 1px solid #000; background-color: #A6A6A6; color: #000; text-align:left; padding:2px'><b>CARAGA</b></th>"+
									...
									if(rs.city[n].id == rs.rs[m].municipality_id){
										...
										$("#evac_stats tbody").append(
											"<tr style='cursor:pointer' ondblclick='updateEC("+rs.rs[m].id+")' class='hoveredit'>"+
												...
												"<td style='border: 1px solid #000; color: #000; text-align:center; padding:2px; "+style+"'>"+addComma(isnull(rs.rs[m].ec_cum))+"</td>"+
							  					"<td style='border: 1px solid #000; color: #000; text-align:center; padding:2px; "+style+"'>"+addComma(isnull(rs.rs[m].ec_now))+"</td>"+
							  					...
							  					"<td style='border: 1px solid #000; color: #000; text-align:left; padding:2px; "+style+"'>"+rs.rs[m].ec_status+"</td>"+
											"</tr>"
										)
									}
		...
		// MASTER QUERY REVISION =================================================================================================================================================
				...
				for(var p in provinces){
					...
					$("#tbl_masterquery_rev tbody").append(
						"<tr>"+
							"<td style='border:1px solid #000; background-color:#BFBFBF; color: #000; padding-left: 5px'><b>"+provinces[p].name+"</b></td>"+
							"<td style='text-align:center; font-weight:bold; border:1px solid #000; background-color:#BFBFBF; color: #000;'></td>"+
							"<td style='text-align:center; font-weight:bold; border:1px solid #000; background-color:#BFBFBF; color: #000;'></td>"+
							"<td style='text-align:center; font-weight:bold; border:1px solid #000; background-color:#BFBFBF; color: #000;'>"+addComma(isnull(bnum))+"</td>"+
							"<td style='text-align:center; font-weight:bold; border:1px solid #000; background-color:#BFBFBF; color: #000;'>"+addComma(isnull(family_a_t))+"</td>"+
							"<td style='text-align:center; font-weight:bold; border:1px solid #000; background-color:#BFBFBF; color: #000;'>"+addComma(isnull(person_a_t))+"</td>"+
							...
							"<td style='text-align:center; font-weight:bold; border:1px solid #000; background-color:#BFBFBF; color: #000;'>"+addComma(isnull(person_cum_s_t))+"</td>"+
							"<td style='text-align:center; font-weight:bold; border:1px solid #000; background-color:#BFBFBF; color: #000;'>"+addComma(isnull(person_now_s_t))+"</td>"+
							"<td style='text-align:center; font-weight:bold; border:1px solid #000; background-color:#BFBFBF; color: #000;'>"+addComma(isnull(tott_d))+"</td>"+
							"<td style='text-align:center; font-weight:bold; border:1px solid #000; background-color:#BFBFBF; color: #000;'>"+addComma(isnull(tot_d))+"</td>"+
							"<td style='text-align:center; font-weight:bold; border:1px solid #000; background-color:#BFBFBF; color: #000;'>"+addComma(isnull(part_d))+"</td>"+
							"<td style='text-align:right; font-weight:bold; border:1px solid #000; background-color:#BFBFBF; color: #000;'>"+addCommaMoney(isnull(rdswd_asst))+"</td>"+
							"<td style='text-align:right; font-weight:bold; border:1px solid #000; background-color:#BFBFBF; color: #000;'>"+addCommaMoney(isnull(rlgu_asst))+"</td>"+
							"<td style='text-align:right; font-weight:bold; border:1px solid #000; background-color:#BFBFBF; color: #000;'>"+addCommaMoney(isnull(rngo_asst))+"</td>"+
							"<td style='text-align:right; font-weight:bold; border:1px solid #000; background-color:#BFBFBF; color: #000;'>"+addCommaMoney(isnull(rtotal_asst))+"</td>"+
						"</tr>"
					)
								...
								if(rs.masterquery[h].municipality_id == rs.city[mm].id){
									...
									$("#tbl_masterquery_rev tbody").append(
										"<tr style='cursor:pointer' class='contextmenu_click' id='contextmenu_click."+rs.city[mm].id+"'>"+
											"<td style='border:1px solid #000; color: #000; background-color: #D8D8D8; padding-left: 20px'><b>"+rs.city[mm].municipality_name.toUpperCase()+"</b></td>"+
											"<td style='font-weight: bold; text-align:center; border:1px solid #000; color: #000; background-color: #D8D8D8'></td>"+
											"<td style='font-weight: bold; text-align:center; border:1px solid #000; color: #000; background-color: #D8D8D8'></td>"+
											"<td style='font-weight: bold; text-align:center; border:1px solid #000; color: #000; background-color: #D8D8D8'>"+addComma(isnull(all_affected_brgy))+"</td>"+
											"<td style='font-weight: bold; text-align:center; border:1px solid #000; color: #000; background-color: #D8D8D8'>"+addComma(isnull(all_affected_f))+"</td>"+
											"<td style='font-weight: bold; text-align:center; border:1px solid #000; color: #000; background-color: #D8D8D8'>"+addComma(isnull(all_affected_p))+"</td>"+
											"<td style='font-weight: bold; text-align:center; border:1px solid #000; color: #000; background-color: #D8D8D8'>"+addComma(isnull(ec_cum))+"</td>"+
											"<td style='font-weight: bold; text-align:center; border:1px solid #000; color: #000; background-color: #D8D8D8'>"+addComma(isnull(ec_now))+"</td>"+
											"<td style='font-weight: bold; text-align:center; border:1px solid #000; color: #000; background-color: #D8D8D8'>"+addComma(isnull(rs.masterquery[h].family_cum_i))+"</td>"+
											"<td style='font-weight: bold; text-align:center; border:1px solid #000; color: #000; background-color: #D8D8D8'>"+addComma(isnull(rs.masterquery[h].family_now_i))+"</td>"+
											// "<td style='font-weight: bold; text-align:center; border:1px solid #000; color: #000; background-color: #D8D8D8'></td>"+
											// "<td style='font-weight: bold; text-align:center; border:1px solid #000; color: #000; background-color: #D8D8D8'></td>"+
											"<td style='font-weight: bold; text-align:center; border:1px solid #000; color: #000; background-color: #D8D8D8'>"+addComma(isnull(rs.masterquery[h].person_cum_i))+"</td>"+
											"<td style='font-weight: bold; text-align:center; border:1px solid #000; color: #000; background-color: #D8D8D8'>"+addComma(isnull(rs.masterquery[h].person_now_i))+"</td>"+
											"<td style='font-weight: bold; text-align:center; border:1px solid #000; color: #000; background-color: #D8D8D8'>"+addComma(isnull(rs.masterquery[h].family_cum_o))+"</td>"+
											"<td style='font-weight: bold; text-align:center; border:1px solid #000; color: #000; background-color: #D8D8D8'>"+addComma(isnull(rs.masterquery[h].family_now_o))+"</td>"+
											"<td style='font-weight: bold; text-align:center; border:1px solid #000; color: #000; background-color: #D8D8D8'>"+addComma(isnull(rs.masterquery[h].person_cum_o))+"</td>"+
											"<td style='font-weight: bold; text-align:center; border:1px solid #000; color: #000; background-color: #D8D8D8'>"+addComma(isnull(rs.masterquery[h].person_now_o))+"</td>"+
											"<td style='font-weight: bold; text-align:center; border:1px solid #000; color: #000; background-color: #D8D8D8'>"+addComma(isnull(rs.masterquery[h].family_cum_s_t))+"</td>"+
											"<td style='font-weight: bold; text-align:center; border:1px solid #000; color: #000; background-color: #D8D8D8'>"+addComma(isnull(rs.masterquery[h].family_now_s_t))+"</td>"+
											"<td style='font-weight: bold; text-align:center; border:1px solid #000; color: #000; background-color: #D8D8D8'>"+addComma(isnull(rs.masterquery[h].person_cum_s_t))+"</td>"+
											"<td style='font-weight: bold; text-align:center; border:1px solid #000; color: #000; background-color: #D8D8D8'>"+addComma(isnull(rs.masterquery[h].person_now_s_t))+"</td>"+
											"<td style='font-weight: bold; text-align:center; border:1px solid #000; color: #000; background-color: #D8D8D8'>"+addComma(isnull(btott_d))+"</td>"+
											"<td style='font-weight: bold; text-align:center; border:1px solid #000; color: #000; background-color: #D8D8D8'>"+addComma(isnull(btot_d))+"</td>"+
											"<td style='font-weight: bold; text-align:center; border:1px solid #000; color: #000; background-color: #D8D8D8'>"+addComma(isnull(bpart_d))+"</td>"+
											"<td style='font-weight: bold; text-align:right; font-weight:bold; border:1px solid #000; color: #000; background-color: #D8D8D8'>"+addCommaMoney(isnull(bdswd_asst))+"</td>"+
											"<td style='font-weight: bold; text-align:right; font-weight:bold; border:1px solid #000; color: #000; background-color: #D8D8D8'>"+addCommaMoney(isnull(blgu_asst))+"</td>"+
											"<td style='font-weight: bold; text-align:right; font-weight:bold; border:1px solid #000; color: #000; background-color: #D8D8D8'>"+addCommaMoney(isnull(bngo_asst))+"</td>"+
											"<td style='font-weight: bold; text-align:right; font-weight:bold; border:1px solid #000; color: #000; background-color: #D8D8D8'>"+addCommaMoney(isnull(btotal_asst))+"</td>"+
										"</tr>"
									)
								}
							}
				...
				for(var v in provinces){
					...
					$('#tbl_casualty_asst tbody').append(
						"<tr style='background-color:yellow'>"+
							...
							"<th style='border: 1px solid #000; text-align:center; background-color: #BFBFBF; color: #000; padding-right: 5px'>"+addComma(dead_ccc)+"</th>"+
							"<th style='border: 1px solid #000; text-align:center; background-color: #BFBFBF; color: #000; padding-right: 5px'>"+addComma(injured_ccc)+"</th>"+
							"<th style='border: 1px solid #000; text-align:center; background-color: #BFBFBF; color: #000; padding-right: 5px'>"+addComma(missing_ccc)+"</th>"+
...
$('#disaster_map').click(function(){
	...
	$.getJSON(serverip+"get_map",datas,function(states){
		...
		var map = L.map('mapid').setView([8.8015, 125.7407], 8.5);
		...
		legend.onAdd = function (map) {
		    ...
		    // }
		    div.innerHTML += '<i style="background-color: #FFEDA0"></i>No Displacement<br>';
		    div.innerHTML += '<i style="background-color: #BD0026"></i>With Displacement<br>';
